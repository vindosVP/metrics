...
import (
	...
	models "github.com/vindosVP/metrics/internal/models"
)
...
// InsertBatch provides a mock function with given fields: ctx, batch
func (_m *MetricsStorage) InsertBatch(ctx context.Context, batch []*models.Metrics) error {
