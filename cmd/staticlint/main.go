// Package consists multi checker
//
// Included analyzers:
//
// all standard static analyzers of the package [https://pkg.go.dev/golang.org/x/tools/go/analysis/passes]
//
// SA and ST analyzers of the package [https://staticcheck.io/]
//
// sqlRows analyzer [https://github.com/gostaticanalysis/sqlrows]
//
// Analyzer checking of the os.Exit call in main function of the main package.
//
...
import (
	...
	"github.com/vindosVP/metrics/pkg/mainexit"
)
...
func otherAnalyzers() []*analysis.Analyzer {
...
func saAnalyzers() []*analysis.Analyzer {
